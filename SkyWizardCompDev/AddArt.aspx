<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddArt.aspx.cs" Inherits="Diseño.AddArt" EnableViewState="false" %>
    ...
    <div class="container-fluid">
        ...
        <form id="form1" runat="server">
            ...
            <div style="font-style: italic;">
                ...
                <telerik:RadWizard ID="RadWizard1" Runat="server" OnInit="RadWizard1_Init" OnClientButtonClicked="OnClientButtonClicked"  Localization-Next="Siguiente" Localization-Previous="Anterior" Localization-Finish="Terminar" OnFinishButtonClick="RadWizard1_FinishButtonClick" DisplayNavigationButtons="false">
                </telerik:RadWizard>
                <asp:Button ID="btnFinalizar" runat="server" Text="Finalizar" CssClass="btn btn-success" OnClick="btnFinalizar_Click" OnClientClick="quitaValidacion()"/>
                <asp:Button ID="btnCancelar" runat="server" Text="Cancelar" CssClass="btn btn-danger" OnClick="btnFinalizar_Click" OnClientClick="quitaValidacion()"/>
                <br />
