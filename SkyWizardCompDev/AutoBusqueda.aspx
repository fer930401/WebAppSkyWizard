...
<body>
    ...
    <form id="form1" runat="server" >
        ...
        <telerik:RadWizard ID="RadWizard1" Runat="server" DisplayNavigationButtons="false" Width="98%">
            <WizardSteps>
                <telerik:RadWizardStep ID="RadWizardStep1" runat="server" Title="Busqueda de Registros">
                    <asp:Panel ID="Panel1" runat="server" Height="400px" Width="95%">
                        <div class="row">
                                <div class="col-md-3">
                                    <div class="input-group"> 
                                        <label>Tipo de artículo:</label><br />
                                        <telerik:RadComboBox ID="cmbArtTip1" Runat="server" AllowCustomText="False" AutoPostBack="True"  MarkFirstMatch="True" OnSelectedIndexChanged="cmbArtTip1_SelectedIndexChanged" Width="100%" ></telerik:RadComboBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="input-group"> 
